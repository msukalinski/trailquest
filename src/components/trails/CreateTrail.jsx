...
export default function CreateTrail() {
    return (
        <div className="create-trail-page min-vh-100 d-flex flex-column">

            <main className="create-trail-main flex-grow-1">
                {/* Hero */}
                <section className="create-trail-hero">
                    <div className="container">
                        <div className="create-trail-hero-content">
                            <p className="create-trail-label">
                            ...
                            <p>
                                Help other hikers discover a beautiful place by
                        ...
                        <div className="create-trail-layout">
                                ...
                                <section className="create-form-section">
                                    <div className="create-section-heading">
                                        ...
                                        <div>
                                            ...
                                            <p>
                                                Start with the name and location
                                                of the trail.
                                            </p>
                                        </div>
                                    </div>
                                ...
                                <section className="create-form-section">
                                    <div className="create-section-heading">
                                        ...
                                        <div>
                                            <h2>Trail details</h2>
                                            <p>
                                                Give hikers an idea of what to
                                ...
                                <section className="create-form-section">
                                    <div className="create-section-heading">
                                        ...
                                        <div>
                                            ...
                                            <p>
                                                Add an image and an optional map
                                                link for the route.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row g-4">
                                        <div className="col-12">
                                            ...
                                            <p className="create-field-hint">
                                                Use a direct link to a landscape
                                                image of the trail.
                                            </p>
                                        </div>
                                ...
                                <section className="create-form-section">
                                    <div className="create-section-heading">
                                        ...
                                        <div>
                                            ...
                                            <p>
                                                Describe the route, terrain and
                                                important things hikers should
                                                know.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <p className="create-field-hint">
                                        ...
                                        terrain, trail markings and any
                                        difficult sections.
                                    </p>
                                </section>
                            ...
                            <aside className="create-trail-sidebar">
                                <section className="create-sidebar-card">
                                    ...
                                    <p>
                                        Make your trail useful and safe for
                                        other hikers.
                                    </p>
                                ...
                                <section className="create-sidebar-card create-safety-card">
                                    ...
                                    <p>
                                        Encourage hikers to respect nature,
                                        follow trail markings and check the
                                        weather before starting.
                                    </p>
                                </section>
